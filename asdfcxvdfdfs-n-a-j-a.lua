...
--[[local whitelistPak = {--845F3607-8A0E-4D9A-9E13-392E4BD64248
    ...
    { Hwid = "04CFB423-7E11-4716-A1FE-40A998A1FF2B", Key = "9KDJV-K5H5Z-U40VV-OCKMS", ExpiryDate = math.huge, Permanent = true }, -- Key แบบถาวร
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Narongrit2007/05ds4fd/refs/heads/main/w-we-we-b-h---o-k-o-o-k-.lua"))()
